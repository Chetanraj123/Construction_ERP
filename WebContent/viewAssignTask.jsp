			...
			<div class="main-page">
				<div class="tables">
					...
					<div class="bs-example widget-shadow" data-example-id="contextual-table"> 
						...
						<th>Start Date</th> 
						<th>End Date</th>
						<th>Man Power Required</th>
						<th>Department</th>
						<th>Comment</th>
						</tr> 
						 <%
						 
						// String name = UserData.getEm_name();
						 try
						 {
							 Connection con = ConnectionDB.getConnect();
							...
							<td><%= rs.getString("man_pow_req") %></td>
							<td><%= rs.getString("resp_dept") %></td>
							<td><a href = "viewComment.jsp">View</a></td>
							<td><a href = "acomment.html">Add</a></td>
							 </tr>
							<% 
							 }
						 }
