      ...
      <nav class="navbar navbar-inverse">
		...
		<%
			...
			try
			{
				 ...
				 PreparedStatement ps2 = con.prepareStatement("select ae_name from arc_eng where ae_email=?");
				 ps2.setString(1,UserData.getAe_email());
				 ResultSet rs1 = ps2.executeQuery();
				 
				 if(rs1.next())
				 {
					 UserData.setAe_name(rs1.getString("ae_name"));
				 }
				...
				<div class="tables">
					...
					<div class="bs-example widget-shadow" data-example-id="contextual-table"> 
						...
						<th>Address</th>   
						 ...
						 {
							 Connection con = ConnectionDB.getConnect();
							 PreparedStatement ps1 = con.prepareStatement("select * from employee where em_teamleader=?");
							 ps1.setString(1,UserData.getAe_name());
							 ResultSet rs = ps1.executeQuery();
							 while(rs.next())
							 {
							%>
							<tr class="active"> 
							<th scope="row"><%= rs.getInt("em_id") %></th> 
