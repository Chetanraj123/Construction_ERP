      ...
      <nav class="navbar navbar-inverse">
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="sidebar-menu">
              ...
              <li><a href="RawMviewAssignPro.jsp"><i class="fa fa-angle-right text-red"></i> <span>View Assign Project</span></a></li>
			...
			<div class="main-page">
				<div class="tables">
					...
					<div class="bs-example widget-shadow" data-example-id="contextual-table"> 
						<h4>View Assign Project For Labour Contractor Department:</h4>
						<table class="table"> 
						...
						<th>Department</th> 
						 ...
						 String name = UserData.getDep_name();
						 try
						 {
							 Connection con = ConnectionDB.getConnect();
							 PreparedStatement ps1 = con.prepareStatement("select * from project_assign where department=?");
