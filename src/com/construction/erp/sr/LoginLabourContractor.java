...
/**
 * Servlet implementation class LoginLabourContractor
 */
@WebServlet("/LoginLabourContractor")
public class LoginLabourContractor extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public LoginLabourContractor() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		try
		{
			...
			if(rs.next())
			{
				response.sendRedirect("LabourContractor.html");
			}
			else
			{
				response.sendRedirect("dLabourContractorLogin.html");
			}
		}
		catch(Exception e)
		{
