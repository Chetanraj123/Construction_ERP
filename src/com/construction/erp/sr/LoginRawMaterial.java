...
/**
 * Servlet implementation class LoginRawMaterial
 */
@WebServlet("/LoginRawMaterial")
public class LoginRawMaterial extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public LoginRawMaterial() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		try
		{
			...
			if(rs.next())
			{
				response.sendRedirect("RawMaterial.html");
			}
			else
			{
				response.sendRedirect("dRawMaterialLogin.html");
			}
		}
		catch(Exception e)
		{
